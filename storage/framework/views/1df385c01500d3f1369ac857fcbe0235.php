...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        function generateWhatsAppMessage() {
            ...
            let productsText = '';
            <?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                productsText += `- <?php echo $item->product->judul; ?>

                (Oleh: <?php echo $item->product->penulis; ?>)
                Jumlah: <?php echo e($item->quantity); ?> x Rp <?php echo e(number_format($item->product->harga, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pandu-Projek\e-com\resources\views/keranjang.blade.php ENDPATH**/ ?>